...
{
    setWindowTitle("OpenglWindow2");

}

Widget2::~Widget2(void)
{
}
...
void Widget2::resizeGL(int width, int height)
{
...
//    }
    ...
    if(window_selected == 6)
    {
        ...
        reg_window.Drawcloud2();
    }

}

void Widget2::wheelEvent(QWheelEvent *event)//滑轮缩放
{
...
void Widget2::mousePressEvent(QMouseEvent *event)//鼠标按住
{
    lastPos = event->pos();
...
void Widget2::mouseMoveEvent(QMouseEvent *event)//鼠标移动
{
