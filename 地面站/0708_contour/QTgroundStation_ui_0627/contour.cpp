...
int ContourLine::getContourLinefromBoundary(TINtriangle *t, Flag *m, float z)
{
    ...
    float* pz0=new float;
    float* pz1=new float;
    if(pP1==NULL||px0==NULL||px1==NULL||py0==NULL||py1==NULL||
       pz0==NULL||pz1==NULL)
    {
        std::cout<<"Failure of Heap Space Allocation from Boundary."<<std::endl;
    }
    long i=0;
...
//                     << PointNum << std::endl; //used for debugging
            BoundaryContourNum++;
...
//             <<BoundaryContourNum<<std::endl; //used for debugging
    delete pP1;
    delete px0;
    delete px1;
    delete py0;
...
int ContourLine::getContourLinefromInside(TINtriangle *t, Flag *m, float z)
{
    ...
    if(pP1==NULL||px0==NULL||px1==NULL||py0==NULL||py1==NULL||
       pz0==NULL||pz1==NULL)
    {
        std::cout<<"Failure of Heap Space Allocation From Inside"<<std::endl;
    }
    long i=0;
...
//             <<InsideContourNum<<std::endl; //used for debugging
    std::cout<<"sucess"<<std::endl;
    std::cout<<"All Unfitered Contours' Number in Elevation "<<z<<
               " Is: "<<ContourNum<<std::endl;
    delete pP1;
    delete px0;
    delete px1;
    delete py0;
...
//void makeSlightChange(PointNode* p, long PointNum, float Zmin, float Zmax, const int n)
//{
...
{
    if(Zmax<float(ceil(Zmin)+unit))
    {
        std::cout<<"No Contour Lines"<<std::endl;
    }
    else
    {
        float temp=float (ceil(Zmin));
